...
4. Repoint web and worker to the previous immutable release (RC6 → RC5); do not rewrite
...
immutable RC6 and RC5 images without touching production. Existing tags remain
immutable.
