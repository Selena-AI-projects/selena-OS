...
|---|---|---|---|
| Disposable DB | APPROVED | Use an isolated PostgreSQL database and run the full migration chain through 0032 plus the guarded pgTAP suite | disposable only; remove the container after evidence is captured |
