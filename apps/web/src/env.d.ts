...
declare global {
	...
	namespace NodeJS {
		interface ProcessEnv {
			...
			readonly SELENA_RUNTIME_DB_VERIFY_TLS?: string;
			...
			readonly CONTENT_OS_YOUTUBE_API_KEY?: string;
			...
			readonly SELENA_STORAGE_SERVICE_KEY?: string;
			readonly SELENA_SCANNER_PORT?: string;
			...
			readonly SELENA_REGISTRY_WORKER_DATABASE_URL?: string;
