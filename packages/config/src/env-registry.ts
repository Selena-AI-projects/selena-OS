...
export const ENV_REGISTRY: EnvVarSpec[] = [
	...
	{
		name: "SELENA_STAGING_PREVIEW_ENABLED",
		scope: "server",
		requiredBy: "optional",
	...
	},
	{
		...
		scope: "server",
		requiredBy: "optional",
		description: "Internal URL of the isolated Selena private-asset scanner runtime.",
	},
	{
		name: "SELENA_SCANNER_INTERNAL_TOKEN",
		scope: "server",
		requiredBy: "optional",
		credential: true,
		description:
			"Shared internal authentication token for Selena web-to-scanner requests; never exposed to the browser.",
	},
	{
		name: "SELENA_STORAGE_API_URL",
		scope: "server",
		requiredBy: "optional",
		description: "Supabase project URL used only by the scanner Storage API client.",
	},
	{
		name: "SELENA_STORAGE_SERVICE_KEY",
		scope: "server",
		requiredBy: "optional",
		credential: true,
		description: "Supabase Storage service credential used only by the isolated Selena scanner runtime.",
	},
	{
		name: "SELENA_SCANNER_PORT",
		scope: "server",
		requiredBy: "optional",
		description: "Private HTTP port for the Selena scanner runtime.",
	},
	{
		name: "CLAMAV_HOST",
		scope: "server",
		requiredBy: "optional",
		description: "Hostname of the local ClamAV daemon used by the isolated scanner runtime.",
	},
	{
		name: "CLAMAV_PORT",
		scope: "server",
		requiredBy: "optional",
		description: "TCP port of the local ClamAV daemon used by the isolated scanner runtime.",
	},
	{
		name: "SELENA_GATEWAY_INTERNAL_TOKEN",
		scope: "server",
		requiredBy: "optional",
		credential: true,
		description:
	...
	},
	{
		...
		requiredBy: "optional",
		credential: true,
		description: "Ed25519 private key available only to the Selena Release Gateway for immutable manifest signatures.",
	},
	{
		name: "SELENA_GATEWAY_SIGNING_KEY_VERSION",
		scope: "server",
		requiredBy: "optional",
		description: "Opaque version identifier of the Release Gateway signing key.",
	},
	{
		name: "SELENA_GATEWAY_PORT",
		scope: "server",
		requiredBy: "optional",
		description: "Private HTTP port for the isolated Selena Release Gateway runtime.",
	},
	{
		name: "SELENA_TRIGGER_API_URL",
		scope: "server",
		requiredBy: "optional",
		description: "HTTPS Trigger.dev API origin used by the registry worker after the Trigger project is approved.",
	},
	{
		name: "SELENA_TRIGGER_TASK_ID",
		scope: "server",
		requiredBy: "optional",
